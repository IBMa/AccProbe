...
public class GlobalTrackingAction extends Action
{

	
	public static final String ID = "org.a11y.utils.accprobe.actions.GlobalTrackingAction";

	private IAccessibilityService accService = null;

	public GlobalTrackingAction (IWorkbenchWindow window, String label) {
	...
	public void run () {
		...
		if (accService != null && accService instanceof MsaaAccessibilityService) {
			if (isChecked()) {
				view.enableGlobalTracking();
			}else {
				view.disableGlobalTracking();
			}
		}
	}
}
